...
/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../scss/main.scss */ "./frontend/src/scss/main.scss");
  ...
  swiperEl.forEach(el => {
    ...
    if (swiperOptionRaw) {
      try {
        ...
        console.log(option);
        const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](className, {
...
function initPreFilledValues(form, submitBtn) {
  try {
    ...
    function displayPrefilledValues(input) {
      ...
      const toggleBtnText = filtersItem.querySelector('.filters__item-toggle-text');
      const selectedOption = dropdown.querySelector(`a[data-term-id="${inputValue}"]`);
...
function initFilterDropdown(selector) {
  try {
    ...
    filtersItemArr.forEach(function (filtersItem) {
      ...
      const toggleBtnText = filtersItem.querySelector('.filters__item-toggle .filters__item-toggle-text');
...
async function loadCities(countryId) {
  ...
  const cityToggleBtnText = cityFilterItem.querySelector('.filters__item-toggle-text');
  ...
  cityDropdown.innerHTML = cities.map(el => `<li class="filters__item-dropdown-item">
  ...
  cityDropdown.addEventListener('click', function (e) {
    ...
    if (!option) return;
    {
      ...
      const name = option.textContent.trim();
      input.value = termId;
      cityToggleBtn.querySelector('.filters__item-toggle-text').textContent = name;
      cityDropdown.querySelectorAll('a').forEach(a => a.classList.remove('selected'));
      option.classList.add('selected');
