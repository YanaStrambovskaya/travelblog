...
module.exports = {
  entry: { // this defines where Webpuck starts the building process.
    main: './frontend/src/js/main.js',
    style: './frontend/src/scss/main.scss',
    reactApp: './frontend/src/react/index.jsx',
  },

  output: { // define where and how bundles are safed
  ...
  module: { 
    rules: [ // how webpack handes .jsx and .scss
        {
  ...
  plugins: [
    ...
    new MiniCssExtractPlugin({ // create css file
