...
?>
<div class="recent-post-card gap-5 flex-column-direction space-between">
    <a class="position-relative" href="<?= esc_url( get_category_link( $related_category->term_id ) ); ?>">
    ...
    <a class="margin-bottom-auto" href="<?= esc_url(get_permalink()) ;?>">
        <?= the_post_thumbnail('medium', [
            'class' => 'destination-image ratio-4-3'
        ]) ;?>
    </a>
    <h3 class="margin-bottom-auto item-title no-margin-top">
    ...
    <div class="meta-date-container flex gap-10">
        ...
        <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta('ID') ) ); ?>" class="author">
            <img class="pencil_icon" src="<?php echo get_template_directory_uri() . '/assets/icons/pencil-gray.svg' ;?>" alt="calendar">
    ...
    <a href="<?= get_permalink() ;?>">
        ...
        <img class="arrow-icon" width="20" height="20" src="<?php echo get_template_directory_uri() . '/assets/icons/arrow-up-right-svgrepo-com.svg' ;?>"/>
    </a>
</div>