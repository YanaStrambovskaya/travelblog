...
?>
<div class="recent-post-card flex-column-direction space-between">
    <div class="category-label">
        <a href="<?= esc_url( get_category_link( $related_category->term_id ) ); ?>">
            <span class="flex">
                ...
                <span class="category-name"><?= esc_html( $related_category->name ); ?></span>
            </span>
            <span class="category-label-bg">
    ...
    <h3 class="item-title no-margin">
        <a class="multi-line-underline" href="<?= get_permalink() ;?>">
            <span><?= the_title() ;?></span>
        </a>
    </h3>
