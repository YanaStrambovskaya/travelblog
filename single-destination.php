          ...
          <div class="swiper sigle-destination-swiper" data-swiper=<?php echo json_encode($swiperOptions) ;?>>
            <div class="swiper-wrapper">
              <?php foreach ($gallery as $image) : ?>
                <div class="swiper-slide grid">
                    <img class="ratio-4-3" src="<?php echo esc_url( $image ); ?>" loading="lazy"
                    decoding="async" alt="">
                </div>
              <?php endforeach; ?>
            </div>
            <div class="swiper-button prev visible-tablet visible-desktop">
              <div class="swiper-button__arrow">
                ...
                <img class="default" src="<?php echo THEME_URI . '/assets/icons/hero-slider-torn-bg.svg' ;?>" loading="lazy"
                decoding="async" alt="">
                <img class="hover" src="<?php echo THEME_URI . '/assets/icons/hero-slider-torn-bg-hover.svg' ;?>" loading="lazy"
                decoding="async" alt="">
            </div>
          </div>
